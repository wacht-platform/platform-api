...
use crate::{
    ...
    core::{
        models::{AiTool, AiToolWithDetails, AiToolType},
        commands::{Command, CreateAiToolCommand, UpdateAiToolCommand, DeleteAiToolCommand},
        queries::{GetAiToolsQuery, GetAiToolByIdQuery, Query as QueryTrait},
    },
};
