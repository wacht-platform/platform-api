...
impl Default for DeploymentDisplaySettings {
    fn default() -> Self {
        Self {
            ...
            tos_page_url: None,
            sign_in_page_url: None,
            sign_up_page_url: None,
            after_sign_out_one_page_url: None,
            after_sign_out_all_page_url: None,
            favicon_image_url: None,
            logo_image_url: None,
            privacy_policy_url: None,
            signup_terms_statement: Some(
                "I agree to the Terms of Service and Privacy Policy".to_string(),
            ),
