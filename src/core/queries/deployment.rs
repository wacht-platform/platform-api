        ...
        Ok(DeploymentWithSettings {
            ...
            display_settings: if row.display_settings_id.is_some() {
                Some(DeploymentDisplaySettings {
                    ...
                    tos_page_url: row.tos_page_url.unwrap_or_default(),
                    privacy_policy_url: row.privacy_policy_url.unwrap_or_default(),
                    signup_terms_statement: row.signup_terms_statement.unwrap_or_default(),
