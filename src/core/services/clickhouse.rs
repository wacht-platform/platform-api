...
impl ClickHouseService {
    ...
    pub async fn get_unique_signins(&self, deployment_id: i64, from: DateTime<Utc>, to: DateTime<Utc>) -> Result<i64, AppError> {
    ...
    pub async fn get_signups(&self, deployment_id: i64, from: DateTime<Utc>, to: DateTime<Utc>) -> Result<i64, AppError> {
    ...
    pub async fn get_organizations_created(&self, deployment_id: i64, from: DateTime<Utc>, to: DateTime<Utc>) -> Result<i64, AppError> {
    ...
    pub async fn get_workspaces_created(&self, deployment_id: i64, from: DateTime<Utc>, to: DateTime<Utc>) -> Result<i64, AppError> {
    ...
    pub async fn get_recent_signups(&self, deployment_id: i64, limit: i32) -> Result<Vec<RecentSignup>, AppError> {
        ...
        Ok(rows.into_iter().map(|row| RecentSignup {
            name: row.user_name,
